 ...
 */
package com.hybris.clavrit.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.hybris.clavrit.constants.YcommercewebservicesConstants;
import com.hybris.clavrit.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "clavritwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "clavritwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "clavritwebservices.oauth2.tokenUrl";

	private static final String DESC = "clavritwebservices.v2.description";
	private static final String TITLE = "clavritwebservices.v2.title";
	private static final String VERSION = "clavritwebservices.v2.version";
	private static final String LICENSE = "clavritwebservices.v2.license";
	private static final String LICENSE_URL = "clavritwebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "clavritwebservices.content.negotiation.legacy";
