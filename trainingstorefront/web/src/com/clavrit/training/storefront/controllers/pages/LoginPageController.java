 ...
 */
package com.clavrit.training.storefront.controllers.pages;

import com.clavrit.training.storefront.filters.PreferredStoreFilter;
import de.hybris.platform.acceleratorstorefrontcommons.controllers.pages.AbstractLoginPageController;
import de.hybris.platform.acceleratorstorefrontcommons.forms.RegisterForm;
import de.hybris.platform.cms2.exceptions.CMSItemNotFoundException;
import de.hybris.platform.cms2.model.pages.AbstractPageModel;
import de.hybris.platform.cms2.model.pages.ContentPageModel;
import com.clavrit.training.storefront.controllers.ControllerConstants;
...
public class LoginPageController extends AbstractLoginPageController
{
			...
			throws CMSItemNotFoundException
	{
		...
		String baseStoreModel = getSessionService().getAttribute("baseStoreModel");
		LOG.info("The value of preferred store is:" +baseStoreModel);
		String preferredStore = getSessionService().getAttribute("preferredStore");
		LOG.info("The value of preferred store is:" +preferredStore);
