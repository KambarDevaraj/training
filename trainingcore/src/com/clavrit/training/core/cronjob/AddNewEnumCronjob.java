...
public class AddNewEnumCronjob extends AbstractJobPerformable<CronJobModel> {
    ...
    public PerformResult perform(CronJobModel cronJobModel) {
        ...
        model.setCode("ONEPLUS");
        model.setName("ONEPLUS Mobile");
        modelService.save(model);
        LOG.info("Added new enum value: ONEPLUS");
